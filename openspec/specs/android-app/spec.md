...
The Android application provides a native mobile interface for the Interstitial Journal, connecting to the shared Firebase backend (Authentication and Firestore) used by the web application.
