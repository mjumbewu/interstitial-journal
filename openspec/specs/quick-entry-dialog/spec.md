...
A lightweight, translucent overlay activity that allows the user to quickly create a new journal entry from the home screen (via widget or shortcut) without a full context switch into the app.
