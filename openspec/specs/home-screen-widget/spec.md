...
An Android home screen widget (Jetpack Glance) that surfaces recent journal entries and provides a shortcut to create new entries without opening the full app.
